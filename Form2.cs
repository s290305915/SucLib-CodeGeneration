...
namespace CodeGeneration
{
    public partial class Form2 : Form
    {
        ...
        public Form2(string db, List<string> tbs, string add, string uname, string pass)
        {
            InitializeComponent();
            ...
            tbnames = tbs;
            connection = string.Format(@"Data Source={0};Initial Catalog={1};User ID={2};Pwd={3}", add, db, uname, pass);
        }
        ...
        private void btn_floder_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == dia_savefloder.ShowDialog())
            {
        ...
        public string GetType(string Dttype)
        {
            ...
            switch (Dttype)
            {
                ...
                case "varbinary":
                case "xml":
                    newtype = "string"; break;
                case "datetime":
                case "date":
                case "time":
                case "timestamp":
                    newtype = "DateTime"; break;
                case "decimal":
                case "float":
                case "numeric":
                case "money":
                    newtype = "Double"; break;
            }
            return newtype;
        }
        #endregion
